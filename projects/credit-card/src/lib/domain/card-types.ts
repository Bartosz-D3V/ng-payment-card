...
import { range } from '@cc-project/lib/shared/helpers';
...
cardTypes.set(CardType.DINERS_CLUBCARTE_BLANCHE, range(300, 305));
cardTypes.set(CardType.DINERS_CLUB_INTERNATIONAL, [...range(300, 305), '309', '36', '38', '39']);
cardTypes.set(CardType.DINERS_CLUB_US_AND_CANADA, ['38', '39']);
cardTypes.set(CardType.DISCOVER_CLUB, ['6011', ...range(622126, 622925), ...range(644, 649), '65']);
cardTypes.set(CardType.JCB, range(6528, 6589));
...
cardTypes.set(CardType.MASTERCARD, range(50, 55));
