...
cardTypes.set(CardType.DINERS_CLUBCARTE_BLANCHE, stringify(range(300, 305)));
cardTypes.set(CardType.DINERS_CLUB_INTERNATIONAL, [...stringify(range(300, 305)), '309', '36', '38', '39']);
cardTypes.set(CardType.DINERS_CLUB_US_AND_CANADA, ['38', '39']);
cardTypes.set(CardType.DISCOVER_CLUB, [
  '6011',
  ...stringify(range(622126, 622925)),
  ...stringify(range(644, 649)),
  '65',
]);
cardTypes.set(CardType.JCB, stringify(range(6528, 6589)));
...
cardTypes.set(CardType.MAESTRO, [
  ...
  '6304',
  '6759',
  ...stringify(range(6701, 6703)),
  '0604',
  '6390',
]);
cardTypes.set(CardType.DANKORT, ['5019']);
cardTypes.set(CardType.MASTERCARD, stringify(range(50, 55)));
